...
function exportArtboardAdvanced(artboard: Artboard, data: ExportData, savePath: string, i: number) {
    ...
    data.artboards[i].imagePath  = exportImage(
        artboard,
        {
            format: 'png',
        ...
        savePath ,
         "preview/" + data.artboards[i].slug,
        data.artboards[i].name
    );
    data.artboards[i].imageIconPath =  exportImage(artboard, {
        format: 'png',
    ...
    savePath,
     "preview/icons/" + data.artboards[i].slug,
        data.artboards[i].name
    );
